...
switch(tool) {
  ...
  break;
  case "rubber chicken":
  alert("Oh my god you are sooo screwed!");
}
var action1 = tool;
  ...
  var action3 = prompt("You begin to walk toward the cliff, what do you do next? Tuck your tail between your legs and look for an easier way to the top.(top) Pound your chest like Tarzan and begin to scale the cliff wall.");
